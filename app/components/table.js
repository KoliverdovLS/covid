...
export default function table(context) {
  ...
  summaryByCountry().then((data) => {
    ...
    columnDest.className = ('wrap-col col-sm-12 col-md-3 h3 align-items-center bg-success border p-0 m-0 align-self-stretch');
    columnCases.className = ('wrap-col col-sm-12 col-md-3 h3 bg-success border min-h-100 p-0 m-0 align-self-stretch');
    columnDeath.className = ('wrap-col col-sm-12 col-md-3 h3 bg-success border p-0 m-0 align-self-stretch');
    columnRecov.className = ('wrap-col col-sm-12 col-md-3 h3 bg-success border p-0 m-0 align-self-stretch');

    const columnDestTop = document.createElement('div');
    const columnDestLow = document.createElement('div');
    columnDestTop.className = ('table-where col-sm-6 h3 bg-transparent p-3 m-0');
    columnDestLow.className = ('table-date col-sm-6 col-md-12 h3 bg-transparent p-3 m-0');
    ...
    columnCasesTop.className = ('col-sm-6 h3 bg-transparent p-3 m-0');
    columnCasesLow.className = ('col-sm-6 table-case col-md-12 h3 bg-transparent p-3 m-0');

    const columnDeathTop = document.createElement('div');
    const columnDeathLow = document.createElement('div');
    columnDeathTop.className = ('col-sm-6 h3 bg-transparent p-3 m-0');
    columnDeathLow.className = ('col-sm-6 table-death col-md-12 h3 bg-transparent p-3 m-0');

    const columnRecovTop = document.createElement('div');
    const columnRecovLow = document.createElement('div');
    columnRecovTop.className = ('col-sm-6 h3 bg-transparent p-3 m-0');
    columnRecovLow.className = ('col-sm-6 table-recov col-md-12 h3 bg-transparent p-3 m-0');
